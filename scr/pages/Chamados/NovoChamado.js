...
import { View, ScrollView, StyleSheet, Picker, TextInput } from 'react-native';
    ...
    render(){
        return(
            <View style={{flex:1}}>
                ...
                <View style={{flex:1}}>
                    <ScrollView>
                        <Text h4 style={{marginLeft:20}}>Selecione o Cliente</Text>
                        <View style={{borderRadius: 10, borderWidth: 1, borderColor: '#bdc3c7', overflow: 'hidden', marginLeft: 20, marginRight: 20, marginBottom: 20}}>
                            <Picker
                                style={pickerStyle}
                        ...
                        <Text h4 style={{marginLeft:20}}>Contato Cliente</Text>
                        <View style={{borderRadius: 10, borderWidth: 1, borderColor: '#bdc3c7', overflow: 'hidden', marginLeft: 20, marginRight: 20, marginBottom: 20}}>
                            <Picker
                                style={pickerStyle}
                                selectedValue={this.state.language}
                        ...
                        <Text h4 style={{marginLeft:20}}>Prioridade</Text>
                        <View style={{borderRadius: 10, borderWidth: 1, borderColor: '#bdc3c7', overflow: 'hidden', marginLeft: 20, marginRight: 20, marginBottom: 20}}>                
                            <Picker
                                style={pickerStyle}
                                selectedValue={this.state.language}
                        ...
                        <Text h4 style={{marginLeft:20}}>Selecione a Área</Text>
                        <View style={{borderRadius: 10, borderWidth: 1, borderColor: '#bdc3c7', overflow: 'hidden', marginLeft: 20, marginRight: 20, marginBottom: 20}}>                
                            <Picker
                                style={pickerStyle}
                                selectedValue={this.state.language}
                        ...
                        <Text h4 style={{marginLeft:20}}>Selecione a Categoria</Text>
                        <View style={{borderRadius: 10, borderWidth: 1, borderColor: '#bdc3c7', overflow: 'hidden', marginLeft: 20, marginRight: 20, marginBottom: 20}}>                
                            <Picker
                                style={pickerStyle}
                                selectedValue={this.state.language}
                        ...
                        <Text h4 style={{marginLeft:20}}>Selecione o Assunto</Text>
                        <View style={{borderRadius: 10, borderWidth: 1, borderColor: '#bdc3c7', overflow: 'hidden', marginLeft: 20, marginRight: 20, marginBottom: 20}}>                
                            <Picker
                                style={pickerStyle}
                                selectedValue={this.state.language}
                        ...
                        <Text h4 style={{marginLeft:20}}>Status</Text>
                        <View style={{borderRadius: 10, borderWidth: 1, borderColor: '#bdc3c7', overflow: 'hidden', marginLeft: 20, marginRight: 20, marginBottom: 20}}>                
                            <Picker
                                style={pickerStyle}
                                selectedValue={this.state.language}
                        ...
                        <Text h4 style={{marginLeft:20}}>Nível de Suporte</Text>
                        <View style={{borderRadius: 10, borderWidth: 1, borderColor: '#bdc3c7', overflow: 'hidden', marginLeft: 20, marginRight: 20, marginBottom: 20}}>                
                            <Picker
                                style={pickerStyle}
                                selectedValue={this.state.language}
